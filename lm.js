// Bazi XKDG - Versione universale finale
...
function calculateXKDG(event) {
  ...
  try {
    ...
    celle.forEach(el => {
      ...
      if (['stem','branch','pinyin','year','month','day','hour','undefined'].includes(txt)) return;
    ...
    alert('Fatto! Aggiornate ' + scritti + ' celle: ' + risultati.join(' '));
