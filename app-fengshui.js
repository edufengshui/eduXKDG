...
function showQimenChart(isoDate, hGan, hZhi, highlightPalace){
  ...
  function cellHtml(p){
    ...
    var jia = '';
    if(d.jiaName){
      jia = '<div onclick="event.stopPropagation();showJiaPopup(\''+d.jiaName+'\')" style="font-size:9px;color:#e65100;font-weight:bold;line-height:1.1;cursor:pointer;text-decoration:underline dotted;">' + d.jiaName + '</div>';
    }
    // Zhi Fu / Zhi Shi marker — clickable
    var zMark = '';
    if(d.zhiFu)  zMark = '<div onclick="event.stopPropagation();showZhiPopup(\'zhiFu\')" style="font-size:9px;color:#e65100;font-weight:bold;line-height:1.1;cursor:pointer;text-decoration:underline dotted;">直符</div>';
    if(d.zhiShi) zMark = '<div onclick="event.stopPropagation();showZhiPopup(\'zhiShi\')" style="font-size:9px;color:#e65100;font-weight:bold;line-height:1.1;cursor:pointer;text-decoration:underline dotted;">直使</div>';
